...
public class FerreiroAtributos : MonoBehaviour
{
    ...
    public void EvoluirVidaMax()
    {
        ...
        {
            status.Vida_Maxima += powerUpVida;
            status.Vida += powerUpVida;
    ...
    public void EvoluirManaMax()
    {
        ...
        {
            status.Mana_Maxima += powerUpMana;
    ...
    public void EvoluirAtaque()
    {
        ...
        {
            status.Ataque_Maximo += powerUpAtaque;
            status.Ataque += powerUpAtaque;
    ...
    public void EvoluirDefesa()
    {
        ...
        {
            status.Defesa_Maxima += powerUpDefesa;
            status.Defesa += powerUpDefesa;
